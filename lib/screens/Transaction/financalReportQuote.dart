    ...
    return Scaffold(
      ...
      body:   Container(
        ...
        child: FinancialReportClass(
          top: Text('',style: kTextStyle.copyWith(color: AppColor.lightTextColor,fontSize: 24,fontWeight: FontWeight.w600,),),
          middle: Container(
             child: Column(
               children: [
                 Text('“Financial freedom is freedom from fear.”',style: kTextStyle.copyWith(color: Colors.white,fontSize: 32,fontWeight: FontWeight.w700,),textAlign:TextAlign.center),
                displaySizedBox(height: 10),
                 Text('-Robert Kiyosaki',style: kTextStyle.copyWith(color: Colors.white,fontSize: 24,fontWeight: FontWeight.w600,),textAlign: TextAlign.right,),
               ],
             ),
           ) ,
          end:Button(
